 ...
 * GameWrapper
 *
 * This React component wraps the Phaser engine into its own
 * lifecycle. When the provided phase configuration or bitmask changes,
 * the wrapper creates a new PhaserGameEngine instance.
 * The `onGameOver` and `onReturnToMenu` callbacks bubble events up
 * to the parent so that routing logic can respond appropriately.
 */
